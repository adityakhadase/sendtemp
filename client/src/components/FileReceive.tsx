  ...
  return (
    <div className="bg-white rounded-xl p-5 sm:p-6 flex flex-col justify-between shadow-xs border border-neutral-200/90 h-full">
      <div className="flex flex-col gap-4">
        {/* Top Header Row matching 60-30-10 Minimalist screenshot */}
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="font-sans text-xs text-neutral-500 mt-0.5">
                Enter the 6-digit key generated by the sender.
              </p>
            </div>

            {/* Stylized Code Input Form with # prefix and backspace clear */}
            <div className="flex flex-col gap-3">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full bg-[#fafafa] py-3.5 pl-10 pr-12 rounded-lg font-mono text-xl sm:text-2xl text-center tracking-widest text-neutral-950 placeholder:text-neutral-300 focus:outline-none focus:bg-white transition-all border border-neutral-200 focus:border-neutral-400 shadow-2xs"
                />
              ...
              {/* Reassurance Banner matching screenshot */}
              <div className="bg-neutral-50 border border-neutral-200/80 rounded-lg p-2.5 flex items-center gap-2 text-xs font-mono text-neutral-500 mt-1">
        ...
        {view === 'found' && metadata && (
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[11px] px-2 py-0.5 rounded bg-neutral-100 text-neutral-700 font-medium">
                SHA-256 Validated
              </span>
            </div>

            {/* File Details Card */}
            <div className="p-4 bg-[#fafafa] rounded-lg flex flex-col gap-3 border border-neutral-200/90">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-lg bg-white border border-neutral-200 flex items-center justify-center text-neutral-900 shadow-2xs shrink-0">
        ...
        {view === 'downloading' && metadata && (
          <div className="flex flex-col gap-4 py-2">
            ...
            {/* Download Meter */}
            <div className="p-4 bg-[#fafafa] rounded-lg flex flex-col gap-2.5 border border-neutral-200">
            ...
            <button
              type="button"
              onClick={resetToDefault}
              className="w-full py-2.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 text-neutral-900 font-mono text-xs font-semibold transition-colors flex items-center justify-center gap-1"
            >
        ...
        {view === 'expired' && (
          <div className="flex flex-col gap-3 text-center py-6">
            ...
            <div className="inline-flex mx-auto px-3 py-1 rounded bg-neutral-100 font-mono text-[11px] text-neutral-600 border border-neutral-200">
