...
export const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-on-surface flex flex-col selection:bg-surface-container-highest selection:text-primary">
        ...
        <div className="h-14 max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-flex items-center px-1.5 py-0.5 rounded bg-surface-container text-on-surface-variant font-mono text-[11px] border border-outline-variant/40">
                v1.0 • zero-retention
              </span>
            </div>
          </div>
      ...
      <main className="w-full flex-1 max-w-7xl mx-auto px-4 sm:px-8 py-6 sm:py-8 flex flex-col items-center">
        {/* Mobile View Toggle */}
        <div className="w-full max-w-md lg:hidden flex bg-surface-container-lowest p-1 rounded-lg mb-6 border border-outline-variant/30">
          <button
            ...
            className={`flex-1 py-2 rounded-md font-mono text-xs font-semibold transition-all ${
      ...
      <footer className="w-full border-t border-surface-container-high py-4 px-4 bg-surface-container-lowest/50 text-center">
        <p className="font-mono text-xs text-on-surface-variant">
          sendTemp Protocol &bull; Ephemeral In-Memory Stream &bull; Zero-Retention Policy
        </p>
      </footer>
    </div>
  );
